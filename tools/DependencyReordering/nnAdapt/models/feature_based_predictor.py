...
class FeatureBasedPredictor(object):
    ...
    def get_W(self, i):
        return self.projectionLayer.W[i].get_value()

    def get_b(self, i):
        return self.projectionLayer.b[i].get_value()

    def get_logre_W(self):
        return self.projectionLayer.logRegressionLayer.W.get_value()

    def get_logre_b(self):
        return self.projectionLayer.logRegressionLayer.b.get_value()
